...
- ndi_c6_alpha/gamma_single_molecule.lt = this is a file for Moltemplate, it containes the same information of the .data file but in a Moltemplate-readable format. It has been obtained with the ltemplify utility.
